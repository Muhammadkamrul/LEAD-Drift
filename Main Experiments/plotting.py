...
def plot_example_detection_timeline(t, raw_scores, ema_scores, alert_times, events, out_path, ema_threshold, ema_window, label_fontsize=20, legend_fontsize=15, tick_fontsize=20):
    """
    ...
    if first_event:
        ...
        if len(alarms_in_window) > 0:
            ax_zoom.axvline(x=alarms_in_window[0], color='green', linestyle='-', label='Earliest Alert (TP)')
        ...
        ax_zoom.legend(ncol=1, loc='upper right')
